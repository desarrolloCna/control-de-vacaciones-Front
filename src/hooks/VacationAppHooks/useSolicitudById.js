  ...
  useEffect(() => {
    const fetchSolicitud = async () => {
      try {
        ...
        // diasTotales es todo el acumulado histórico, para visualizar en el dashboard
        setDiasDisponiblesT(parseInt(resDias.diasTotales ?? resDias.diasDisponibles ?? 0));
        // diasDisponibles es el acumulado operativo sin el año en curso
        setDiasSolicitablesT(parseInt(resDias.diasDisponibles ?? 0));
